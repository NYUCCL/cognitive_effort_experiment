...
var loadcards = function(cObj){
	...
	var incentive = cObj.incentive;
	var nmarbles, answervalue;
	if (incentive==0){
		// Special case to handle
		nmarbles = 222;
		answervalue = 0;
	} else {
		nmarbles = 128 / incentive;
		answervalue = Math.round( 100 * 10 / nmarbles)/100; // e.g., 2.50 when incentive is 32 (highest) so all answers correct gives $10
	};

	var card_features = [  {"text":["There are 8 different cards."], 
	...
	var task_parts  = [  {"text":["There are two parts to this HIT.",
	...
	var incentives_mag = [{"text":["Now I will explain how to increase the amount of your bonus payment.",
					"Answering more questions correctly on the <b>test</b> earns you more <b>bonus tickets</b>.",
					"Each bonus ticket is worth <b>$"+answervalue.toFixed(2)+ "</b>, so more bonus tickets means a larger bonus payment."],
					"images":["incentives02.png"],
					"marbles":[null, null],
							"clock":null
					},
					{"text":["Remember, there are 8 questions total on the <b>test</b>.",
					"If you get all 8 correct, your bonus will be <b>$" + (4*answervalue).toFixed(2) + '</b>.'],
					"images":["4tickets.png"],
					"marbles":[null,null],
							"clock":null
					},
					{"text":["Remember, there are 8 questions total on the <b>test</b>.",
					"If you get 7 correct, your bonus will be <b>$" + (3*answervalue).toFixed(2) + '</b>.'],
					"images":["3tickets.png"],
					"marbles":[null,null],
							"clock":null
					},
					{"text":["Remember, there are 8 questions total on the <b>test</b>.",
					"If you get 6 correct, your bonus will be <b>$" + (2*answervalue).toFixed(2) + '</b>.'],
					"images":["2tickets.png"],
					"marbles":[null,null],
							"clock":null
					},
					{"text":["Remember, there are 8 questions total on the <b>test</b>.",
					"If you get 5 correct, your bonus will be <b>$" + (1*answervalue).toFixed(2) + '</b>.'],
					"images":["1ticket.png"],
					"marbles":[null,null],
							"clock":null
					},
					...
					{"text":["The bonus you earn will be added to your experiment base payment.",
