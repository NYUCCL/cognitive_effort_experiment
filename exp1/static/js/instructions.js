...
var loadcards = function(cObj){
	...
	var task_parts  = [  {"text":["There are two parts to this HIT.",
							...
							{"text":["You can increase your chances of winning a <b>BONUS payment of $10</b> by doing well on the test."], 
							 "images":["taskparts03.png"],
							 "marbles":[null,null],
							"clock":null
							}
							];

	var incentives = [{"text":["Now I will explain how to increase your chances at winning a $10 bonus.",
	...
	var review = [  {"text":["<b>Let's review!</b>",
							...
							"Doing better on the test increases your chance at winning a $10 bonus payment."], 
							 "images":["allcards00.png"],
							 "marbles":[null,null],
							"clock":null
					},
