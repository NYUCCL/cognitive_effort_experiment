...
// NEW VERSION: condition is from 0 to 18, tells rule and incentive
var mycondition = condition; // these two variables are passed by the psiturk server process
var mycounterbalance = counterbalance;  // they tell you which condition you have been assigned to

var rules = [0,1,2,3,4,5];
var incentives = [2,16,32];

var NLEARNINGREPS = 2; // number of times each stim is seen during learning (mult by 8 for ntrials)
...
$(window).on('load', async () => {
	...
	conditionObj = {incentive: incentives[Math.floor(mycondition/6)], // number of points each correct answer is worth
				rule: mycondition % 6,// 0-5; type I-VI
